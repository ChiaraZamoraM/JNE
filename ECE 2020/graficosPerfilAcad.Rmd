...
```{r}
base=ggplot(data=all2, aes(x=nivelEducativo,y=porcentaje,fill=sexo))
base +   geom_bar(stat="identity",position = 'dodge') +facet_grid(joven~.) + coord_flip() +theme_linedraw() + theme(legend.position="bottom")
```
